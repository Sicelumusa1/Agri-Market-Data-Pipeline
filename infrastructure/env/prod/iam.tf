...
resource "google_service_account" "github_scraper" {
  account_id   = "github-scraper-prod"
  display_name = "GitHub Actions Scraper SA - Prod"
}
...
resource "google_iam_workload_identity_pool_provider" "github_scraper" {
  ...
  workload_identity_pool_provider_id = "github-scraper-provider-prod"
  display_name                       = "GitHub Scraper Provider - Prod"
